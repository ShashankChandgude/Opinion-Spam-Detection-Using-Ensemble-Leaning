...
def run_model_pipeline():
    ...
    best_models, best_params = optimize_all_classifiers(BASE_CLASSIFIERS, HYPERPARAMS,
                                                        X_train_vec, y_train)
    ...
    bagging_ensembles, stacking_ensemble = train_all_ensembles(
        BASE_CLASSIFIERS, best_params, X_train_vec, y_train, best_models)
    ...
    train_err, test_err = compute_errors(best_models, bagging_ensembles,
